...
static UI_METHOD *UI_OPENSSLNull(void)
{
...
static int ssl_ui_reader(UI *ui, UI_STRING *uis)
{
  ...
  return (UI_method_get_reader(UI_OPENSSLNull()))(ui, uis);
}
...
static int ssl_ui_writer(UI *ui, UI_STRING *uis)
{
  ...
  return (UI_method_get_writer(UI_OPENSSLNull()))(ui, uis);
}
    ...
    case SSL_FILETYPE_ENGINE:
      ...
      {                         /* XXXX still needs some work */
        ...
        if(data->state.engine) {
          ...
          UI_method_set_opener(ui_method, UI_method_get_opener(UI_OPENSSLNull()));
          UI_method_set_closer(ui_method, UI_method_get_closer(UI_OPENSSLNull()));
